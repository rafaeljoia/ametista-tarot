...
const NAV: { href: string; label: string; icon: IconKey }[] = [
  ...
  { href: '/admin/consultas', label: 'Atendimentos', icon: 'sessions' },
  { href: '/admin/conversas', label: 'Conversas', icon: 'conversations' },
  { href: '/admin/reviews', label: 'Avaliações', icon: 'reviews' },
  { href: '/admin/pricing', label: 'Preços', icon: 'pricing' },
  { href: '/admin/termos', label: 'Termos de Uso', icon: 'terms' },
